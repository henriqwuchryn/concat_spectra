...
sample.to_csv('CLASSES.CSV', index=False, header=False)
...
spectra_df.to_csv('NUMEROS DE ONDA.csv', index=False)
...
spectra_df.to_csv(f'ESPECTROS.csv', header=False, index=False)
